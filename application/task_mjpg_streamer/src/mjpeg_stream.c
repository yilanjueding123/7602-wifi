...
extern void wifi_connected_state(INT8U flag);
// Return    0: Success
...
void mjpeg_stream_task(void *pvParameters)
{
	...
	for(;; )
	{
		...
		/*else			//Temporary delete else branch
		{
		}*/
...
ssv6xxx_set_rate_mask(RC_DEFAULT_RATE_MSK);	
