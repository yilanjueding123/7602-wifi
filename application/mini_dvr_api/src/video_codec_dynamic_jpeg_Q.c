...
/*
	if (vlcSize > JPEG_DISP_OUT_BUFFER_SIZE - (10*1024))
	{
		disp_current_Y_Q_value -= 20;	
	}
*/	
	else if (vlcSize > (JPEG_DISP_OUT_BUFFER_SIZE-(15*1024)))  //25
	{
		disp_current_Y_Q_value -= 4;
	}
	else if (vlcSize < (JPEG_DISP_OUT_BUFFER_SIZE-(25*1024)))  //15
	{
		disp_current_Y_Q_value += 2;
	}
