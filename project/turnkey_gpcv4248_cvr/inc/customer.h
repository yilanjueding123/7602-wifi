...
//========================================================================
	...
	#define SCCB_SCL						IO_E6// Sensor I2C clock pin
	#define SCCB_SDA						IO_E7// Sensor I2C data pin	
    ...
    #define POWER_EN_PIN					IO_B4
    #define CHARGE_DETECTION_PIN			IO_B5
    ...
    #define WIFI_LDO_EN						IO_C12	//IO_B3
	...
	#define POWERON_BATTERY_CHECK           0
//====================Liuxi modified in 2015-01-15==================================    
	//LED 有效电平; =0,低有效; =1,高有效	
    #define LED1							IO_F15 //blue
    #define LED2							IO_A0 //red
	#define WIFI_LED						IO_A1 
    #define IR_LED1							IO_E0 //ir led //green
...
//注意复用的口要设置成通用IO
    ...
    #define COOLER_PIN_IO_01	    IO_E1			
    #define COOLER_PIN_IO_02	    IO_E2		
    #define COOLER_PIN_IO_03	    IO_E3		
    #define COOLER_PIN_IO_04	    IO_E4			
    #define COOLER_PIN_IO_05	    IO_E5				
...
//========================================================================
#define WIFI_SSID_NAME					"JH-7602B" //8个字符

#define PRODUCT_NUM						7602// 7663
#define PRODUCT_DATA					20171120
#define PROGRAM_VERSION_NUM				7 // 4	
